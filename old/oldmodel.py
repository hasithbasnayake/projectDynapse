...
class Net(nn.Module):
    def __init__(self,
        ...
        torch.nn.init.uniform_(self.fc1.weight, a=0.0, b=1.0, generator=generator)
    ...
    def forward(self, x):
        ...
        for step in range(x.shape[0]):  
            ...
            if torch.any(spk):
                ...
                print(f"Neuron {random_neuron} spiked")
        ...
        return torch.stack(spk_rec), torch.stack(mem_rec), random_neuron, step
